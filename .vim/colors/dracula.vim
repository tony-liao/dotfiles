...
" New definitions for status line colours
hi StatusFileMeta ctermfg=117 ctermbg=237
hi StatusFileName ctermbg=238
hi StatusFileLocation ctermfg=212 ctermbg=236
...
hi VertSplit ctermfg=NONE ctermbg=NONE cterm=bold guifg=NONE guibg=NONE gui=bold
